...
#define FIRMWARE_TRANSPARENT_DRIVER_ID (2)
...
#if (defined(FIRMWARE_DRIVER_ENABLED) )
            status = firmware_transparent_generate_key
                (attributes,
                                key_buffer,
                                key_buffer_size,
                                key_buffer_length
...
#if (defined(FIRMWARE_DRIVER_ENABLED) )
            status = firmware_transparent_import_key
                (attributes,
                                data,
                                data_length,
                                key_buffer,
...
#if (defined(FIRMWARE_DRIVER_ENABLED) )
            status = firmware_transparent_key_agreement
                (attributes,
                                key_buffer,
                                key_buffer_size,
                                alg,
